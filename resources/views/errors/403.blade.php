...
<head>
    ...
    <title>Access Forbidden - Al Munawwara Islamic School</title>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="status-badge">
                ...
                <span>403 - Forbidden / غير مسموح بالدخول</span>
            </div>

            <!-- Error Messaging -->
            <div class="heading-ar">عذراً، ليس لديك صلاحية للوصول إلى هذه الصفحة</div>
            <div class="heading-en">Access to This Resource is Restricted</div>

            <div class="divider"></div>

            <p class="description-ar">
                الوصول إلى هذه الصفحة محظور بسبب نقص الصلاحيات الكافية لحسابك. إذا كنت تعتقد أن هذا خطأ، يرجى التواصل مع الدعم الفني للمدرسة.
            </p>
            <p class="description-en">
                You do not have permission to view this page or directory using the credentials that you supplied. Please contact the system administrator if you believe this is an error.
            </p>

            <!-- Action Button -->
            <div style="margin-bottom: 32px;">
                <a href="{{ auth()->check() ? route('payment.dashboard') : route('login') }}" class="btn-action">
                    Return to Portal / العودة إلى بوابة التسجيل
                </a>
            </div>

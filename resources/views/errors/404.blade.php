...
<head>
    ...
    <title>Page Not Found - Al Munawwara Islamic School</title>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="status-badge">
                ...
                <span>404 - Page Not Found / الصفحة غير موجودة</span>
            </div>

            <!-- Error Messaging -->
            <div class="heading-ar">عذراً، لم نتمكن من العثور على هذه الصفحة</div>
            <div class="heading-en">Oops, We Couldn't Find That Page</div>

            <div class="divider"></div>

            <p class="description-ar">
                الصفحة التي تحاول الوصول إليها قد تكون تم نقلها أو حذفها أو غير موجودة بالأساس. يرجى التحقق من العنوان أو العودة إلى الصفحة الرئيسية.
            </p>
            <p class="description-en">
                The page you are looking for might have been removed, had its name changed, or is temporarily unavailable. Please verify the URL or return to the main dashboard.
            </p>

...
<?php $component = App\View\Components\GuestLayout::resolve(['showLoader' => false] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<div id="login-page" class="login-grid login-page visible">
    <section class="login-info auth-hero-panel">
        <div class="login-brand-block auth-hero-brand">
            <img src="<?php echo e(asset('images/AMIS_Logo.png')); ?>" alt="AMIS">
            <div>
        ...
        <div class="auth-hero-flow">
            ...
            ?>
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => [$title, $copy]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="login-form-panel">
            <div class="auth-entry-card" x-data="{ 
                ...
                submitEmail() {
                    ...
                    fetch('<?php echo e(route('auth.send-otp')); ?>', {
                        method: 'POST',
                        headers: {
                ...
                verifyOtpCode() {
                    ...
                    fetch('<?php echo e(route('auth.verify-otp')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name=&quot;csrf-token&quot;]').getAttribute('content')
                ...
                <div x-show="step === 'email'">
                    ...
                    <a href="<?php echo e(route('auth.google')); ?>" class="btn-google-auth-premium" style="margin-bottom: 0.75rem;">
                    ...
                    <a href="<?php echo e(route('auth.microsoft')); ?>" class="btn-microsoft-auth-premium" style="margin-bottom: 1.25rem;">
...
<?php endif; ?>
<?php /**PATH /home/tatsuya/Projects/AMIS/amis_payment/resources/views/auth/login.blade.php ENDPATH**/ ?>